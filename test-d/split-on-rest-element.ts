...
expectType<SplitOnRestElement<[...[string?, number?]], {keepOptionals: false}>>({} as [[string, number], [], []]);
...
// Unions
expectType<SplitOnRestElement<[...Array<string | number>, boolean]>>({} as [[], [string | number], [boolean]]);
expectType<SplitOnRestElement<[...Array<{id: string}>, number]>>({} as [[], [{id: string}], [number]]);
expectType<SplitOnRestElement<[1, ...Array<[string, number]>, 2]>>({} as [[1], [[string, number]], [2]]);
...
expectType<SplitOnRestElement<[0, 1?, 2?, ...never[]], {keepOptionals: false}>>({} as [[0, 1, 2], [never], []]);
expectType<SplitOnRestElement<[number?, ...string[]]>>({} as [[number?], [string], []]);
expectType<SplitOnRestElement<[number?, ...string[]], {keepOptionals: false}>>({} as [[number], [string], []]);
