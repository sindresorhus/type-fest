...
expectType<IsTuple<[number?, string?] | [] | [number, string, ...number[]]>>(true);
expectType<IsTuple<[number?, string?] | [] | [number, string, ...number[]], {fixedLengthOnly: true}>>({} as boolean);
...
expectType<IsTuple<[number, string, ...number[]], {fixedLengthOnly: boolean}>>(true);
