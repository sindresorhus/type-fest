...
- [`SetOptional`](source/set-optional.d.ts) - Create a type that makes optional the defined properties.
- [`SetRequired`](source/set-required.d.ts) - Create a type that requires the defined properties
