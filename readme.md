...
- [`SplitOnRestElement`](source/split-on-rest-element.d.ts) - Splits an Array on its [`Rest`](https://www.typescriptlang.org/docs/handbook/2/objects.html#tuple-types) element portion into three parts: `[[...Head], [Rest], [...Tail]]`.
