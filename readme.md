...
- [`UnknownMap`](source/unknown-map.d.ts) - Represents a map with `unknown` keys and values.
- [`UnknownSet`](source/unknown-set.d.ts) - Represents a set with `unknown` values.
