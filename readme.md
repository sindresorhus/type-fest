...
- [`StringSlice`](source/string.d.ts) - Returns a string slice of a given range(with negative index support), just like `String.slice` in js.

### Array

- [`Includes`](source/includes.d.ts) - Returns a boolean for whether the given array includes the given item.
- [`Join`](source/join.d.ts) - Join an array of strings and/or numbers using the given string as a delimiter.
- [`ArraySlice`](source/array-slice.d.ts) - Returns an array slice of a given range(with negative index support), just like `Array.slice` in js.
...
- [`IsNegative`](source/numeric.d.ts) - Returns a boolean for whether the given number `T` is a negative number.
- [`Add`](source/numeric.d.ts) - Return the result of `A + B`.
- [`Subtract`](source/numeric.d.ts) -Return the result of `A - B`.
