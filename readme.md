...
- [`ObjectMerge`](source/object-merge.d.ts) - Merge two object types into a new object type such that keys from the second object type override keys from the first object type.
