...
/**
If the given type `T` is `any`, the returned type is `TypeIfAny`.
Otherwise, the return type is `TypeIfNotAny`.
If only `T` is specified, `TypeIfAny` will be `true` and `TypeIfNotAny` will be false.
