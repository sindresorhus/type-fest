...
/**
Many collections have an `.entries()` method that will return an iterable of that structure's keys and values. The `Entry` type will return the type of that collection's entry given the type itself.
