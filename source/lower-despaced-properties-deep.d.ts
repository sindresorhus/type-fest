...
@example
```
import type {LowerDespacedPropertiesDeep} from 'type-fest';
...
const splitOnPunctuation: LowerDespacedPropertiesDeep<{'user@info': {'user::id': number; 'user::name': string}}, {splitOnPunctuation: true}> = {
	userinfo: {
		userid: 1,
		username: 'Tom',
	},
...
@category Object
*/
export type LowerDespacedPropertiesDeep<
	Value,
