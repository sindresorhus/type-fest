...
/**
Filters properties from an object where the property value extends the given type.
...
@example
```
import type {ObjectFilter} from 'type-fest';

type T1 = ObjectFilter<{a: 1; b: 2; c: 3 | 4; d: 3?; e: 4?}, 3>;
//=> {c: 3 | 4; d: 3?}

type T2 = ObjectFilter<{a: 1; b: 2; c: 3 | 4; d: 3?; e: 4?}, 3, {strict: true}>;
//=> {c: 3?}

type T3 = ObjectFilter<{a: 'foo1'; b: 'bar2'; c: 'fooo'; d: 'foo3'}, `foo${number}`>;
//=> {a: 'foo1'; d: 'foo3'}

type T4 = ObjectFilter<{a: 1; b: '2'; c: 3; d: 'foo'; e: false}, string | number>;
//=> {a: 1; b: '2'; c: 3; d: 'foo'}

type T5 = ObjectFilter<{a: true; b: false; c: boolean; d: 0; e: 1}, Boolean>;
//=> {a: true; e: 1}

type T6 = ObjectFilter<{a: 0; b: ''; c: false; d: null; e: undefined; f: 'ok'; g: 42}, Boolean>;
//=> {f: 'ok'; g: 42}
```
